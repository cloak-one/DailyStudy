...
```java
    ...
    @ResponseBody
    public String test(@SessionAttribute("test") String test ){
    ...
    @ResponseBody
    public String test2(@CookieValue("JSESSIONID") String id ){
...
![20240314155842028](assets/image-20240314155842028.png)

```
@RequestScope|@SessionScope将注解加到实体类(model)上
```
